...
slideshow:!0,slideshowSpeed:7E3,animationSpeed:600,initDelay:0,randomize:!1,pauseOnAction:!0,pauseOnHover:!1,useCSS:!0,touch:!0,video:!1,controlNav:!0,directionNav:!0,prevText:"Prev",nextText:"Next",keyboard:!0,multipleKeyboard:!1,mousewheel:!1,pausePlay:!1,pauseText:"Pause",playText:"Play",controlsContainer:"",manualControls:"",sync:"",asNavFor:"",itemWidth:0,itemMargin:0,minItems:0,maxItems:0,move:0,start:function(){},before:function(){},after:function(){},end:function(){},added:function(){},
	...
	this.init = function (){
		if( responsiveFlag == 'block' ){
			...
			slides.kwicks({
				max : 637,
				spacing : 0
			}).find('li > a').click(function (){return false;});
			
			$('.flexslider li')
				.mouseover(function(){
					$(this).find('.hover-img').stop().animate({opacity:1}, 500);
					$(this).find('.flex-caption').stop().animate({bottom:0, right:0}, 500)
				})
				.mouseout(function(){
					$(this).find('.hover-img').stop().animate({opacity:0}, 500);
					$(this).find('.flex-caption').stop().animate({bottom:'-100%', right:-1000}, 500)
				});
		} else {
